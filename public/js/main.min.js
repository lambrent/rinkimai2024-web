...
"use strict";$(document).ready(function(){var e,s;new Swiper(".js-leaders-slider",{slidesPerView:"auto",spaceBetween:20,navigation:{nextEl:".js-leaders-slider-next",prevEl:".js-leaders-slider-prev"},breakpoints:{768:{spaceBetween:42}}});e=".js-tabs-links",s=".js-tabs-panels",$(document).on("click",e,function(a){$(this).hasClass("active")||($(e).removeClass("active").filter('a[href="'+this.hash+'"]').addClass("active"),$(s).slideUp().filter(this.hash).slideDown()),a.preventDefault()})});
